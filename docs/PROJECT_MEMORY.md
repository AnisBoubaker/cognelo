...
- Core owns attempts, attempt limits, gradebook lifecycle, release visibility, audited regrades, research events, and grade challenges. Plugins own activity-specific evaluation and sanitized feedback contracts. A plugin-specific released learner report must independently recheck learner ownership and release state and expose only bounded student-safe evidence.
