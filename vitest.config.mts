...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@cognelo/plugin-coding-homework-grader/server": new URL("./packages/plugin-activities/plugin-coding-homework-grader/src/server.ts", import.meta.url).pathname,
      "@cognelo/plugin-coding-homework-grader": new URL("./packages/plugin-activities/plugin-coding-homework-grader/src/index.ts", import.meta.url).pathname,
