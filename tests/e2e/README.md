...
The maximum-attempt integrity check currently links to [GitHub issue #160](https://github.com/AnisBoubaker/cognelo/issues/160), and the released-grade visibility check links to [GitHub issue #162](https://github.com/AnisBoubaker/cognelo/issues/162), as expected failures. These annotations must not be removed or weakened until the product behaviors are fixed and the original assertions pass.
