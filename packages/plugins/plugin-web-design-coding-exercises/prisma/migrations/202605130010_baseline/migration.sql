...
CREATE UNIQUE INDEX "PluginWebDesignExerciseReferenceBundle_activityId_key" ON "PluginWebDesignExerciseReferenceBundle"("activityId");
CREATE INDEX "PluginWebDesignExerciseTest_activityId_kind_orderIndex_idx" ON "PluginWebDesignExerciseTest"("activityId", "kind", "orderIndex");
CREATE INDEX "PluginWebDesignExerciseTest_activityId_isEnabled_idx" ON "PluginWebDesignExerciseTest"("activityId", "isEnabled");
CREATE INDEX "PluginWebDesignExerciseSubmission_activityId_userId_createdAt_idx" ON "PluginWebDesignExerciseSubmission"("activityId", "userId", "createdAt");
CREATE INDEX "PluginWebDesignExerciseSubmission_userId_createdAt_idx" ON "PluginWebDesignExerciseSubmission"("userId", "createdAt");
CREATE INDEX "PluginWebDesignExerciseSubmission_activityId_kind_createdAt_idx" ON "PluginWebDesignExerciseSubmission"("activityId", "kind", "createdAt");
CREATE INDEX "PluginWebDesignExerciseSubmission_activityId_status_createdAt_idx" ON "PluginWebDesignExerciseSubmission"("activityId", "status", "createdAt");
CREATE INDEX "PluginWebDesignExerciseTestResult_submissionId_idx" ON "PluginWebDesignExerciseTestResult"("submissionId");
CREATE INDEX "PluginWebDesignExerciseTestResult_testId_idx" ON "PluginWebDesignExerciseTestResult"("testId");
CREATE INDEX "PluginWebDesignExerciseTestResult_status_idx" ON "PluginWebDesignExerciseTestResult"("status");
CREATE UNIQUE INDEX "PluginBankWebDesignExerciseReferenceBundle_bankActivityId_key" ON "PluginBankWebDesignExerciseReferenceBundle"("bankActivityId");
CREATE INDEX "PluginBankWebDesignExerciseTest_bankActivityId_kind_orderIn_idx" ON "PluginBankWebDesignExerciseTest"("bankActivityId", "kind", "orderIndex");
