...
- Gradebook **Review and grade** combines the submitted code, latest test evidence, rubric scores, Summary/Strengths/Improvements, and the host final-grade override. Rubric edits recompose first; an explicitly changed final grade is then recorded as a separate teacher override.
