...
- Every coding generation stage receives the shared knowledge mode. Selected skills constrain output; suggestion maps the generated prompt/solution/tests to exact subject skills and updates only the unsaved host draft; ignore does not read or change knowledge links.
