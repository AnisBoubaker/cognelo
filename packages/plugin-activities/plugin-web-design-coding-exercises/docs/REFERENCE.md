# Web Design Coding Exercises Detailed Reference

This document is the detailed reference for the Web Design Coding Exercises plugin.

Platform-wide architecture belongs in the root [README.md](../../../../README.md).
