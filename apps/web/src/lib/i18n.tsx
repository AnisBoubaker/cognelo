...
const messages: Record<Locale, MessageTree> = {
  en: {
    ...
    groupPage: {
      ...
      availableAlways: "Always available once published.",
      availableAfter: "Available after {from}",
      availableBefore: "Available until {until}",
      availableWindow: "Available from {from} until {until}",
      participantsEyebrow: "Participants",
      participantsTitle: "Participants",
      participantsText: "This tab is reserved for group participant management.",
      participantsPlaceholder: "Participant management will be added here next.",
  ...
  fr: {
    ...
    groupPage: {
      ...
      availableAlways: "Toujours disponible une fois publie.",
      availableAfter: "Disponible apres le {from}",
      availableBefore: "Disponible jusqu'au {until}",
      availableWindow: "Disponible du {from} au {until}",
      participantsEyebrow: "Participants",
      participantsTitle: "Participants",
      participantsText: "Cet onglet est reserve a la gestion des participants du groupe.",
      participantsPlaceholder: "La gestion des participants sera ajoutee ici ensuite.",
  ...
  zh: {
    ...
    groupPage: {
      ...
      availableAlways: "发布后始终可用。",
      availableAfter: "在 {from} 之后可用",
      availableBefore: "在 {until} 之前可用",
      availableWindow: "从 {from} 到 {until} 可用",
      participantsEyebrow: "参与者",
      participantsTitle: "参与者",
      participantsText: "这个标签页预留给分组参与者管理。",
      participantsPlaceholder: "参与者管理将在这里继续添加。",
