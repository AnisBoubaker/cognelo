...
const messages: Record<Locale, MessageTree> = {
  en: {
    ...
    parsons: {
      ...
      groupsText: "Select lines beside the editor, create a group, then click the group box on the right to edit its behavior.",
  ...
  fr: {
    ...
    parsons: {
      ...
      groupsText: "Sélectionnez des lignes à côté de l’éditeur, créez un groupe, puis cliquez sur la boîte du groupe à droite pour le modifier.",
  ...
  zh: {
    ...
    parsons: {
      ...
      groupsEyebrow: "顺序规则",
      groupsTitle: "代码行分组",
      groupsText: "先在编辑器旁边选中代码行，再创建分组；点击编辑器右侧的分组框即可修改它。",
      createGroup: "创建分组",
